...
parser.add_argument('--object', help='Path to image file.')
parser.add_argument('--maxAnnotations', help='Path to video file.')
args = parser.parse_args()

classes = [args.object]
maxAnnota = int(args.maxAnnotations) 
...
for ind in range(0, len(classes)):
    ...
    if(args.maxAnnotations and maxAnnota < totalNumOfAnnotations):
      totalNumOfAnnotations = maxAnnota
    print("Using number of annotations : "+str(totalNumOfAnnotations))
